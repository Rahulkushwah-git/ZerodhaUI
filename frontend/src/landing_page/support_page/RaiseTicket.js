    ...
    return ( 
        <div className='container text-muted'>
            ...
            <div className='col-4 p-5 mt-2 mb-5'>
                <h4 className=''>
                <i class="fa fa-minus-square-o" aria-hidden="true"></i>  Funds
                </h4>
                ...
                <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Add bank accounts (CMR) and Depository Participant (DP) </a><br/>
