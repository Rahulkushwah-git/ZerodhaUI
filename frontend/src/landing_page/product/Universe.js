        ...
        <div className='container'>
            <div className='row'>
                ...
                <div className='col-3 mt-5 mb-5 p-5 text-center  '>
                    <a href='https://www.zerodhafundhouse.com/' style={{ textDecoration: "none" }}><img src='Media/zerodhaFundhouse.png' style={{ width: "50%" }} /></a>
                    ...
                    <a className='mt-5' href='https://streak.tech/' style={{ textDecoration: "none" }}><img src='Media/streakLogo.png' style={{ width: "50%" }} /></a>
                ...
                <div className='col-4 mt-5 mb-5 p-5 text-center text-muted '>
                    <a href='https://sensibull.com/' style={{ textDecoration: "none" }}><img src='Media/sensibullLogo.svg' style={{ width: "50%" }} /></a>
                    ...
                    <a className='mt-5' href='https://smallcase.zerodha.com/' style={{ textDecoration: "none" }}><img src='Media/smallcaseLogo.png' style={{ width: "50%" }} /></a>
                ...
                <div className='col-3 mt-5 mb-5 p-5 text-center'>
                    <a href='https://www.tijorifinance.com/' style={{ textDecoration: "none" }}><img src='Media/tijori.svg' style={{ width: "50%" }} /></a>
                    ...
                    <a className='mt-5' href='https://joinditto.in/' style={{ textDecoration: "none" }}><img src='Media/dittoLogo.png' style={{ width: "50%" }} /></a>
                    <p className='text-small text-muted mt-5'>Systematic trading platform that allows you to create and backtest strategies without coding.</p>
                </div>
                <div className='col-1'></div>
